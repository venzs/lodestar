...
for %%M in (Lodestar Lodestar_Leveling Lodestar_Economy Lodestar_UI Lodestar_Guild Lodestar_Guide Lodestar_Guides_Horde Lodestar_Guides_Alliance Lodestar_Character) do (
  if exist "%ADDONS%\%%M" (
